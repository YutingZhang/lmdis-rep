...
if __name__ == "__main__":
    ...
    keypoint_separation_bandwidth=0.06
    keypoint_separation_loss_weight = 16.0
    ...
    # -------------------------------------
    model_dir = os.path.join("results/aflw_10")
    checkpoint_dir = 'pretrained_results'
    checkpoint_filename = 'celeba_10/model/snapshot_step_224549'
