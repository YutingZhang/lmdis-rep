...
class Net:
    def __init__(self, subset_name='train', options = None):
        ...
        self._cat_train = root_path+'data/cat_data/cat_train_images.txt'
        self._cat_test = root_path+'data/cat_data/cat_test_images.txt'
        self._impath = root_path+'data/cat_images/'

        with open(self._cat_train, 'r') as f:
            self._train_imlist = f.read().splitlines()
        with open(self._cat_test, 'r') as f:
            self._test_imlist = f.read().splitlines()
